...
public class ListViewAdapterMercadito extends BaseAdapter {
    // Declare Variables
    MercaditoFragment context;
    String[] titulos;
    String[] mensajes;
    int[] imagenes;
    LayoutInflater inflater;

    public ListViewAdapterMercadito(MercaditoFragment context, String[] titulo, String[] mensaje, int[] imagenes, LayoutInflater inflater) {
